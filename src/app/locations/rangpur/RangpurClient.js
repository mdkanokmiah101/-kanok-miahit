        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight leading-[1.05] mb-6">
            <span className="text-primary">
              Local SEO Expert in Rangpur
            </span>
            <br />Dominate Google Maps
          </h1>
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Your trusted local SEO partner in Rangpur. I help shrimp exporters, industrial businesses, agri-companies, and local service providers dominate Google search and attract more customers online.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Tailored SEO strategies for Rangpur&apos;s distinctive industrial economy — from shrimp export to manufacturing.
            </p>
          </div>
