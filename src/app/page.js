    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="fixed top-0 w-full bg-white/95 backdrop-blur-xl border-b border-gray-100 z-50">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <a href="#contact" className="hidden md:inline-block bg-blue-600 text-white text-sm font-bold px-5 py-2 rounded-full hover:bg-blue-700 hover:shadow-lg hover:shadow-blue-500/25 transition-all">Free Audit</a>
        ...
        {menuOpen && (
          <div className="md:hidden bg-white border-b border-gray-100 px-4 pb-4 flex flex-col gap-3 text-sm font-medium text-gray-600">
            ...
            <a href="/industries" onClick={() => setMenuOpen(false)} className="hover:text-blue-600">Industries</a>
            <a href="/blog" onClick={() => setMenuOpen(false)} className="hover:text-blue-600">Blog</a>
      ...
      {/* === HERO SECTION === */}
      <section className="relative pt-32 pb-24 px-4 overflow-hidden bg-gradient-to-br from-blue-50 via-white to-sky-50">
        ...
        <div className="relative max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          {/* Hero Text */}
          <div>
            <div className="inline-flex items-center gap-2 bg-blue-100 border border-blue-200 text-blue-700 text-xs font-semibold px-5 py-2 rounded-full mb-6">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight leading-[1.1] mb-6">
              <span className="text-blue-600">Best SEO Agency</span>
              <br />
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="#contact" className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-xl font-bold text-lg transition-all hover:shadow-xl hover:shadow-blue-500/30 hover:-translate-y-0.5">
                Get Free SEO Audit
                <span className="group-hover:translate-x-1 transition-transform">→</span>
              </a>
              <a href="#services" className="inline-flex items-center gap-2 border-2 border-gray-200 text-gray-700 px-8 py-4 rounded-xl font-semibold text-lg hover:border-blue-300 hover:text-blue-600 transition-all">
                View Services
              </a>
            </div>
            {/* Trust badges */}
            <div className="mt-12 flex flex-wrap gap-6 text-sm text-gray-500">
              <span className="flex items-center gap-2"><span className="text-blue-600 font-bold">🏆</span> 6+ Years Experience</span>
          ...
          <div className="relative hidden md:block">
            <div className="relative bg-gradient-to-br from-blue-500 to-cyan-400 rounded-3xl p-1 shadow-2xl">
      ...
      <section id="services" className="py-24 px-4 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-blue-600 text-sm font-semibold tracking-widest uppercase">What We Do</span>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="bg-white rounded-2xl p-7 border border-gray-100 hover:border-blue-200 hover:shadow-lg hover:-translate-y-1 transition-all">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              ...
              <a key={i} href={`/industries/${ind.slug}`}
                className="bg-gray-50 rounded-2xl p-6 border border-gray-100 hover:border-blue-200 hover:bg-blue-50 hover:-translate-y-1 transition-all group">
                <div className="text-3xl mb-3">{ind.icon}</div>
                <h3 className="font-bold text-gray-900 mb-1.5 group-hover:text-blue-600 transition-colors">{ind.title}</h3>
                <p className="text-gray-500 text-sm leading-relaxed">{ind.desc}</p>
                <div className="mt-3 text-blue-600 text-xs font-semibold opacity-0 group-hover:opacity-100 transition-opacity">Learn More →</div>
              </a>
            ))}
          </div>
          <div className="text-center mt-10">
            <a href="/industries" className="inline-flex items-center gap-2 text-blue-600 font-semibold hover:text-blue-700">View All Industries →</a>
          </div>
        </div>
      </section>
      ...
      <section id="process" className="py-24 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-blue-600 text-sm font-semibold tracking-widest uppercase">How We Work</span>
          ...
          <div className="grid md:grid-cols-5 gap-6">
            {[
              ...
              <div key={i} className="text-center p-4">
                <div className="w-14 h-14 mx-auto mb-4 rounded-2xl bg-blue-600 text-white flex items-center justify-center font-extrabold text-sm shadow-lg">{p.step}</div>
      ...
      <section className="py-24 px-4 bg-gradient-to-r from-blue-600 to-blue-800">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-blue-200 mb-10 text-lg">Get a free SEO audit for your Bangladesh business. No commitment, no hidden fees.</p>
          <a href="#contact" className="inline-flex items-center gap-2 bg-white text-blue-700 px-10 py-4 rounded-xl font-bold text-lg transition-all hover:shadow-xl hover:-translate-y-0.5">
            Get Your Free Audit →
          </a>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start">
              ...
              <form action="https://formspree.io/f/xvgkrvrz" method="POST" className="space-y-5">
                <div>
                  ...
                  <input type="text" name="name" required placeholder="e.g. Md. Rahim"
                    className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/20 transition-all" />
                </div>
                <div>
                ...
                <div>
                  ...
                  <textarea name="message" required rows="4" placeholder="I need SEO for my e-commerce store in Dhaka..."
                    className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/20 transition-all resize-none"></textarea>
                </div>
                <input type="hidden" name="_subject" value="New SEO Lead from Kanok MiahIT Website!" />
                <input type="text" name="_gotcha" style={{display: "none"}} />
                <button type="submit"
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3.5 px-6 rounded-xl hover:shadow-lg transition-all">
                  Get Free SEO Audit →
                </button>
            ...
            <div className="space-y-6">
              <div className="bg-white border border-gray-200 rounded-2xl p-7 shadow-sm">
                ...
                <a href="tel:+880****3101" className="text-2xl font-extrabold text-blue-600 hover:text-blue-700">+880 1712-883101</a>
              </div>
              <div className="bg-white border border-gray-200 rounded-2xl p-7 shadow-sm">
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-7 shadow-sm">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-center gap-3">
                    ...
                    <a href="mailto:mdkanokmiah232@gmail.com" className="text-gray-600 hover:text-blue-600">mdkanokmiah232@gmail.com</a>
                  </div>
                  <div className="flex items-center gap-3">
                    <span className="text-xl">🌐</span>
                    <a href="https://kanokmiah.com" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-blue-600">kanokmiah.com</a>
                  </div>
                  <div className="flex items-center gap-3">
                    <span className="text-xl">📍</span>
              ...
              <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-6 text-center shadow-sm">
                <p className="text-white text-sm font-semibold">⭐ Free SEO Audit — Worth BDT 5,000</p>
                <p className="text-blue-200 text-xs mt-1">Get a complete analysis of your website. No commitment required.</p>
              </div>
            </div>
          </div>
        </div>
