  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="relative pt-32 pb-16 px-4 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 -right-32 w-80 h-80 bg-blue-500/20 rounded-full blur-3xl animate-pulse delay-1000" />
      ...
      <section className="relative py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <span className="text-blue-600 text-sm font-semibold tracking-widest uppercase">What We Stand For</span>
      ...
      <section className="relative py-16 border-y border-gray-100">
        ...
        <div className="relative max-w-5xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[
            { num: "350+", label: "Projects Done", color: "from-blue-400 to-blue-600" },
            { num: "50+", label: "Happy Clients", color: "from-blue-400 to-blue-600" },
            { num: "95%", label: "Client Retention", color: "from-blue-400 to-blue-600" },
            { num: "6+", label: "Years Exp.", color: "from-blue-400 to-blue-600" },
          ].map((stat, i) => (
            <div key={i}>
      ...
      <section className="relative py-24 px-4 overflow-hidden">
        ...
        <div className="relative max-w-2xl mx-auto text-center">
          ...
          <p className="text-blue-200 mb-10 text-lg">Ready to see what a dedicated SEO partnership can do for your Bangladesh business? Get your free audit today.</p>
          <Link href="/#contact" className="group inline-flex items-center gap-2 bg-white text-blue-700 px-10 py-4 rounded-xl font-bold text-lg transition-all hover:shadow-xl hover:-translate-y-0.5">
            Get Your Free Audit
