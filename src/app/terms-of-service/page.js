    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="pb-24 px-4">
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="bg-gray-50 border border-gray-100 rounded-2xl p-7">
            <h2 className="text-xl font-extrabold text-gray-900 mb-3">3. Client Responsibilities</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div className="bg-gray-50 border border-gray-100 rounded-2xl p-7">
            <h2 className="text-xl font-extrabold text-gray-900 mb-3">4. Payment Terms</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div className="bg-gray-50 border border-gray-100 rounded-2xl p-7">
            <h2 className="text-xl font-extrabold text-gray-900 mb-3">6. Confidentiality</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div className="bg-gray-50 border border-gray-100 rounded-2xl p-7">
            <h2 className="text-xl font-extrabold text-gray-900 mb-3">8. Term and Termination</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div className="bg-gray-50 border border-gray-100 rounded-2xl p-7">
            <h2 className="text-xl font-extrabold text-gray-900 mb-3">9. Disclaimer of Warranties</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div className="bg-gray-50 border border-gray-100 rounded-2xl p-7">
            <h2 className="text-xl font-extrabold text-gray-900 mb-3">10. Governing Law</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div className="bg-gray-50 border border-gray-100 rounded-2xl p-7">
            <h2 className="text-xl font-extrabold text-gray-900 mb-3">11. Changes to Terms</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div className="bg-gray-50 border border-gray-100 rounded-2xl p-7">
            <h2 className="text-xl font-extrabold text-gray-900 mb-3">12. Contact Information</h2>
            <p className="text-gray-600 leading-relaxed">
