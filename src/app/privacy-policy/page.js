      ...
      <section className="pb-24 px-4">
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-7">
            <h2 className="text-xl font-extrabold text-white mb-3">1. Introduction</h2>
          ...
          <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-7">
            <h2 className="text-xl font-extrabold text-white mb-3">2. Information We Collect</h2>
            <h3 className="font-semibold text-white/90 mt-4 mb-2">Personal Data</h3>
            <p className="text-gray-400 leading-relaxed">
            ...
            <h3 className="font-semibold text-white/90 mt-6 mb-2">Usage Data</h3>
            <p className="text-gray-400 leading-relaxed">
            ...
            <h3 className="font-semibold text-white/90 mt-6 mb-2">Cookies &amp; Tracking Technologies</h3>
            <p className="text-gray-400 leading-relaxed">
          ...
          <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-7">
            <h2 className="text-xl font-extrabold text-white mb-3">3. How We Use Your Information</h2>
            <p className="text-gray-400 leading-relaxed">
          ...
          <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-7">
            <h2 className="text-xl font-extrabold text-white mb-3">4. Third-Party Services</h2>
            <p className="text-gray-400 leading-relaxed">
          ...
          <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-7">
            <h2 className="text-xl font-extrabold text-white mb-3">5. Data Security</h2>
            <p className="text-gray-400 leading-relaxed">
          ...
          <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-7">
            <h2 className="text-xl font-extrabold text-white mb-3">6. Your Rights (GDPR Compliance)</h2>
            <p className="text-gray-400 leading-relaxed">
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1 text-gray-400 text-sm">
              ...
              <li><strong className="text-white">Right to Erasure:</strong> Request deletion of your data where applicable.</li>
              ...
              <li><strong className="text-white">Right to Object:</strong> Object to processing for direct marketing purposes.</li>
            </ul>
            <p className="text-gray-400 leading-relaxed mt-3">
          ...
          <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-7">
            <h2 className="text-xl font-extrabold text-white mb-3">7. Cookies Policy</h2>
            <p className="text-gray-400 leading-relaxed">
          ...
          <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-7">
            <h2 className="text-xl font-extrabold text-white mb-3">8. Data Retention</h2>
            <p className="text-gray-400 leading-relaxed">
          ...
          <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-7">
            <h2 className="text-xl font-extrabold text-white mb-3">9. Changes to This Policy</h2>
            <p className="text-gray-400 leading-relaxed">
          ...
          <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-7">
            <h2 className="text-xl font-extrabold text-white mb-3">10. Contact Us</h2>
            <p className="text-gray-400 leading-relaxed">
