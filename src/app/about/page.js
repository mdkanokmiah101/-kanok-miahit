...
export const metadata = {
  title: "About Kanok Miah — SEO Expert in Dhaka, Bangladesh",
  description: "Learn about Kanok Miah \u2014 Bangladesh's trusted SEO expert with 6+ years of experience helping Dhaka businesses rank higher on Google.",
  alternates: { canonical: "https://kanokmiah.com.bd/about" },
  openGraph: {
    title: "About Kanok Miah — SEO Expert in Dhaka, Bangladesh",
    description: "Learn about Kanok Miah — Bangladesh's trusted SEO expert with 6+ years of experience.",
...
const aboutFaqs = [
  { question: "What experience does Kanok Miah have?", answer: "Kanok Miah has since 2019 of hands-on SEO experience, helping 50+ Bangladeshi businesses achieve first-page rankings on Google. His expertise spans local SEO, technical SEO, link building, semantic SEO, and GEO/AI search optimization." },
