  ...
  if (!ind) {
    return (
      <div className="min-h-screen bg-white text-gray-900 flex items-center justify-center flex-col gap-4">
        ...
        <Link href="/industries" className="text-blue-600 hover:underline">← All Industries</Link>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-extrabold mb-8">
            Why You Need <span className="text-blue-600">Industry-Specific SEO</span>
          </h2>
      ...
      <section className="py-16 px-4 bg-gray-50 border-y border-gray-100">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-extrabold mb-8">
            Our <span className="text-blue-600">{ind.shortTitle}</span> SEO Services
          </h2>
          <div className="grid md:grid-cols-2 gap-4">
      ...
      <section className="relative py-24 px-4 overflow-hidden">
        ...
        <div className="relative max-w-2xl mx-auto text-center">
          ...
          <p className="text-blue-200 mb-8 text-lg">Get a free SEO audit tailored for your industry in Bangladesh.</p>
