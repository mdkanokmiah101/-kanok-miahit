    ...
    <footer className="relative bg-gray-900 text-gray-300 pt-16 pb-0 px-4 overflow-hidden">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-10 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            {/* Facebook Icon Link */}
            <a
              href="https://www.facebook.com/mdkanokmiahweb"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 mt-5 bg-[#1877F2] hover:bg-[#166FE5] text-white rounded-xl px-4 py-2.5 transition-colors"
            >
